...
<section class="content-header">
    <h1>
        Equipments        <small>Edit Equipments</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Equipments</h5>
                            <hr>
                        </div>
		          ...
		          <div class="widget-user-header ">
                        ...
                        <?= form_open(base_url('administrator/equipments/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="equipments_equipment_image_uuid" id="equipments_equipment_image_uuid" type="hidden" value="<?= set_value('equipments_equipment_image_uuid'); ?>">
                                <input class="data_file" name="equipments_equipment_image_name" id="equipments_equipment_image_name" type="hidden" value="<?= set_value('equipments_equipment_image_name', $equipments->equipment_image); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="equipment_name" id="equipment_name" placeholder="Equipment Name" value="<?= set_value('equipment_name', $equipments->equipment_name); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="equipment_category_id" id="equipment_category_id" data-placeholder="Select Equipment Category Id" >
                                    ...
                                    <option <?=  $row->id ==  $equipments->equipment_category_id ? 'selected' : ''; ?> value="<?= $row->id ?>"><?= $row->name; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="equipment_condition" id="equipment_condition" data-placeholder="Select Equipment Condition" >
                                    <option value=""></option>
                                    <option <?= $equipments->equipment_condition == "NEW" ? 'selected' :''; ?> value="NEW">NEW</option>
                                    <option <?= $equipments->equipment_condition == "OLD" ? 'selected' :''; ?> value="OLD">OLD</option>
                                    <option <?= $equipments->equipment_condition == "BAD" ? 'selected' :''; ?> value="BAD">BAD</option>
                                    <option <?= $equipments->equipment_condition == "FAIR" ? 'selected' :''; ?> value="FAIR">FAIR</option>
                                    </select>
                                <small class="info help-block">
                                </small>
                            </div>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="equipment_size" id="equipment_size" data-placeholder="Select Equipment Size" >
                                    <option value=""></option>
                                    <option <?= $equipments->equipment_size == "LONG" ? 'selected' :''; ?> value="LONG">LONG</option>
                                    <option <?= $equipments->equipment_size == "VERY LONG" ? 'selected' :''; ?> value="VERY LONG">VERY LONG</option>
                                    <option <?= $equipments->equipment_size == "SHORT" ? 'selected' :''; ?> value="SHORT">SHORT</option>
                                    <option <?= $equipments->equipment_size == "VERY SHORT" ? 'selected' :''; ?> value="VERY SHORT">VERY SHORT</option>
                                    <option <?= $equipments->equipment_size == "NA" ? 'selected' :''; ?> value="NA">NA</option>
                                    </select>
                                <small class="info help-block">
                                </small>
                            </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="equipment_barcode" id="equipment_barcode" placeholder="Equipment Barcode" value="<?= set_value('equipment_barcode', $equipments->equipment_barcode); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="equipment_description" id="equipment_description" placeholder="Equipment Description" value="<?= set_value('equipment_description', $equipments->equipment_description); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_equipments.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id = $('#equipments_image_galery').find('li').attr('qq-file-id');
       ...
       $('#equipments_equipment_image_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'administrator/equipments/get_equipment_image_file/<?= $equipments->id; ?>',
