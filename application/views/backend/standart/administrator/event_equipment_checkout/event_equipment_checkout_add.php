...
<section class="content-header">
    <h1>
        Event Equipment Checkout        <small><?= cclang('new', ['Event Equipment Checkout']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Event Equipment Checkout']); ?></h5>
                            <hr>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/event_equipment_checkout/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
